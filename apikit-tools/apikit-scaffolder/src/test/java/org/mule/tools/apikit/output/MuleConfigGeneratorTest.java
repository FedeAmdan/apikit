...
import org.mule.tools.apikit.ApikitLogger;
...
public class MuleConfigGeneratorTest {
    ...
    public void testGenerate() throws Exception {
        ...
        MuleConfigGenerator muleConfigGenerator = new MuleConfigGenerator(log, new File(""), entries);
        muleConfigGenerator.generate();

        assertTrue(file.exists());
        assertTrue(file.isFile());
        verify(log, never()).error(any(CharSequence.class), any(Throwable.class));
    ...
    public void blankDocument() throws Exception {
        ...
        MuleConfigGenerator muleConfigGenerator =
                new MuleConfigGenerator(log, new File(""), new ArrayList<GenerationModel>());
